...
with st.expander("License (MIT)"):
    st.markdown("""
    This project is licensed under the **MIT License**.

    This is a permissive open-source license that grants broad permissions.

    **You are free to:**
    *   Use the software for any purpose (including commercial use).
    *   Modify the software.
    *   Distribute the software and modified versions.
    *   Sublicense the software.
    *   Use the software privately.

    **The only main condition is:**
    ...
    **Disclaimer:**
    *   The software is provided "AS IS", without warranty of any kind. The authors/copyright holders are not liable for any claim, damages, or other liability.

    [Link to Full License Text](https://opensource.org/licenses/MIT)
    """)
